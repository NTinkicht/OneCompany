...
OneCompany uses patterns because they address repeatable coordination failure modes. A new project should preserve the invariant and may rename the mechanism. For example, a team does not need to call a temporary delivery group a “squad”; it needs bounded ownership, alignment, and a single canonical stream.
