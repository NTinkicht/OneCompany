...
def initialize_control_plane(target: Path, project_name: str, repository: str, default_branch: str) -> None:
    ...
    write_json(target / ".onecompany" / "queue.json", {"$schema": "./schemas/queue.schema.json", "schema_version": "1.0", "work_units": []})
...
def main() -> int:
    ...
    print("Operational queue/state were reset; source work history was not copied. Unattended paths remain disabled.")
    return 0
