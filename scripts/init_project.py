...
def main() -> int:
    ...
    print(f"INITIALIZED OneCompany for {project_name} ({repository}, default={default_branch}, code owner={code_owner})")
    ...
    print("Next: python onecompany.py validate && python onecompany.py github-audit && python onecompany.py plan summary && python onecompany.py status")
    return 0
